...
DEFAULT_LOG = Path(__file__).with_name("cifar_baseline2_eval4_exp3.log")
DEFAULT_OUTPUT_DIR = Path(__file__).with_name("cifar_baseline2_eval4_exp3_plots")
...
def write_summary(runs, search_steps, completions, cache_hits, output_path):
    lines = [
        "CIFAR Baseline Eval4 Exp3 Piecewise Schedule Search",
        "=" * 56,
        "",
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot cifar_baseline2_eval4 exp3 piecewise schedule search."
    )
