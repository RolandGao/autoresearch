...
DEFAULT_LOG = Path(__file__).with_name("cifar_baseline2_eval2_n_search.6log")
DEFAULT_BASELINE_LOG = Path(__file__).with_name("cifar_baseline2_eval2_n_search2.log")
DEFAULT_OUTPUT_DIR = Path(__file__).with_name("cifar_baseline2_eval2_n_search6_plots")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot cifar_baseline2_eval2 n_search6 results with baseline."
    )
