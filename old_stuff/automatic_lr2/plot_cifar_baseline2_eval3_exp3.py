...
DEFAULT_LOG = Path(__file__).with_name("cifar_baseline2_eval3_exp3.log")
DEFAULT_OUTPUT_DIR = Path(__file__).with_name("cifar_baseline2_eval3_exp3_plots")
...
def write_summary(runs, search_steps, completions, cache_hits, output_path):
    ...
    lines = [
        "CIFAR Baseline Eval3 Exp3 Joint Line Search",
        "=" * 45,
        "",
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot cifar_baseline2_eval3 exp3 joint line-search results."
    )
