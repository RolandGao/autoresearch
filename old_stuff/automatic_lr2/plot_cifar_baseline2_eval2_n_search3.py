...
DEFAULT_LOG = Path(__file__).with_name("cifar_baseline2_eval2_n_search3.log")
DEFAULT_BASELINE_LOG = Path(__file__).with_name("cifar_baseline2_eval2_n_search2.log")
DEFAULT_OUTPUT_DIR = Path(__file__).with_name("cifar_baseline2_eval2_n_search3_plots")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot cifar_baseline2_eval2 n_search3 results with baseline."
    )
