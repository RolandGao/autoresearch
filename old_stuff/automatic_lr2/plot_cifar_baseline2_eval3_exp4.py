...
DEFAULT_LOG = Path(__file__).with_name("cifar_baseline2_eval3_exp4.log")
DEFAULT_OUTPUT_DIR = Path(__file__).with_name("cifar_baseline2_eval3_exp4_plots")
...
def write_summary(runs, search_steps, completions, cache_hits, output_path):
    ...
    lines = [
        "CIFAR Baseline Eval3 Exp4 Joint Line Search",
        "=" * 45,
        "",
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot cifar_baseline2_eval3 exp4 joint line-search results."
    )
