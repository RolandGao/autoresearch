...
def update_config(update_name, update_fn, muon_lr=0.061):
    return dict(update_name=update_name, update_fn=update_fn, muon_lr=muon_lr)


# New candidates only; the original six update functions were run in earlier sweeps.
UPDATE_CONFIGS = [
    update_config("column_norm", normalize_columns),
    update_config("column_norm_max", normalize_columns_max),
    update_config("sinkhorn_rows_first_norm", sinkhorn_rows_first_norm),
    update_config("sinkhorn_columns_first_norm", sinkhorn_columns_first_norm),
    update_config("row_centered_row_norm", row_centered_row_norm),
    update_config("column_centered_column_norm", column_centered_column_norm),
    update_config("double_centered_matrix_norm", double_centered_matrix_norm),
    update_config("signed_sqrt_matrix_norm", signed_sqrt_matrix_norm),
    update_config("signed_cuberoot_matrix_norm", signed_cuberoot_matrix_norm),
    update_config("signed_square_matrix_norm", signed_square_matrix_norm),
    update_config("softsign_matrix_norm", softsign_matrix_norm),
    update_config("tanh_matrix_norm", tanh_matrix_norm),
    update_config("factorized_rms_norm", factorized_rms_norm),
    update_config("inverse_factorized_rms_norm", inverse_factorized_rms_norm),
    update_config("row_norm_sqrt_weighted", row_norm_sqrt_weighted),
    update_config("row_norm_inv_sqrt_weighted", row_norm_inv_sqrt_weighted),
    update_config("qr_row_orthogonal", qr_row_orthogonal, muon_lr=0.22),
    update_config(
        "zeropower_via_newtonschulz5_steps1",
        zeropower_via_newtonschulz5_steps1,
        muon_lr=0.22,
    ...
    update_config("zeropower_double_centered", zeropower_double_centered, muon_lr=0.22),
]
