...
def train_one_run(
    ...
    for step in range(steps):
        ...
        should_log = (
            config.log_every > 0
            and ((step + 1) % config.log_every == 0 or step + 1 == config.steps)
        )
        if should_log:
            print(
    ...
    summary = {
        **hparams,
        ...
        "num_samples": steps * config.batch_size,
