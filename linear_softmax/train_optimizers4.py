...
_LR_MEDIANS = {
    ...
    ("Muon", None, 512, 8): 0.31,
    ("Muon", None, 512, 64): 1.6,
    ("Muon", None, 512, 512): 2.3,
    ("Muon", None, 2048, 8): 0.09,
    ("Muon", None, 2048, 64): 0.6,
    ("Muon", None, 2048, 512): 2.0,
    ("Muon", None, 8192, 8): 0.59,
    ("Muon", None, 8192, 64): 0.38,
    ("Muon", None, 8192, 512): 2.1,
    ("Muon", None, 32768, 8): 0.072,
    ("Muon", None, 32768, 64): 0.13,
    ("Muon", None, 32768, 512): 0.66,
    ("MuonH", "matrix", 512, 8): 0.069,
    ("MuonH", "matrix", 512, 64): 0.95,
    ("MuonH", "matrix", 512, 512): 53.0,
    ("MuonH", "matrix", 2048, 8): 0.018,
    ("MuonH", "matrix", 2048, 64): 0.11,
    ("MuonH", "matrix", 2048, 512): 2.0,
    ("MuonH", "matrix", 8192, 8): 0.0074,
    ("MuonH", "matrix", 8192, 64): 0.045,
    ("MuonH", "matrix", 8192, 512): 0.27,
    ("MuonH", "matrix", 32768, 8): 0.0021,
    ("MuonH", "matrix", 32768, 64): 0.0071,
    ("MuonH", "matrix", 32768, 512): 0.04,
    ("MuonH", "row", 512, 8): 0.13,
    ("MuonH", "row", 512, 64): 12.0,
    ("MuonH", "row", 512, 512): 42.0,
    ("MuonH", "row", 2048, 8): 0.015,
    ("MuonH", "row", 2048, 64): 0.19,
    ("MuonH", "row", 2048, 512): 0.77,
    ("MuonH", "row", 8192, 8): 0.0045,
    ("MuonH", "row", 8192, 64): 0.053,
    ("MuonH", "row", 8192, 512): 0.28,
    ("MuonH", "row", 32768, 8): 0.0022,
    ("MuonH", "row", 32768, 64): 0.0081,
    ("MuonH", "row", 32768, 512): 0.098,
...
LR_RANGES = {
    key: (lr_median * 1e-2, lr_median * 1e2) for key, lr_median in _LR_MEDIANS.items()
}
LR_DECAY = 4.0
